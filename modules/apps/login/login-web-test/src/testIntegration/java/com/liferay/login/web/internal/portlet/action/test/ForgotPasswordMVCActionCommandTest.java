...
public class ForgotPasswordMVCActionCommandTest {
	...
	private int _getPasswordHashCount(String emailAddress) throws Exception {
		...
		ServiceRegistration<PasswordEncryptor> serviceRegistration =
			bundleContext.registerService(
				...
				new CountingPasswordEncryptor(atomicInteger),
				HashMapDictionaryBuilder.<String, Object>put(
	...
	private static class CountingPasswordEncryptor
		...
		private CountingPasswordEncryptor(AtomicInteger atomicInteger) {
