...
@Generated("")
@GraphQLName(
	description = "A JCA security provider.", value = "SecurityProvider"
)
@io.swagger.v3.oas.annotations.media.Schema(
	description = "A JCA security provider."
)
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "SecurityProvider")
public class SecurityProvider implements Serializable {

	public static SecurityProvider toDTO(String json) {
		return ObjectMapperUtil.readValue(SecurityProvider.class, json);
	}

	public static SecurityProvider unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(SecurityProvider.class, json);
	}
	...
	@GraphQLField(description = "The provider name.")
	...
	@GraphQLField(description = "The provider version.")
	@JsonProperty(access = JsonProperty.Access.READ_WRITE)
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		...
		defaultValue = "com.liferay.portal.security.fips.rest.dto.v1_0.SecurityProvider",
		name = "x-class-name"
	)
...
// LIFERAY-REST-BUILDER-HASH:1251554093