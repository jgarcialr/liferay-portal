...
@Generated("")
@OpenAPIDefinition(
	info = @Info(description = "Read-only view of the active FIPS 140-3 cryptographic configuration.. A Java client JAR is available for use with the group ID 'com.liferay', artifact ID 'com.liferay.portal.security.fips.rest.client', and version '1.0.0'.", license = @License(name = "Apache 2.0", url = "http://www.apache.org/licenses/LICENSE-2.0.html"), title = "Security FIPS", version = "v1.0")
)
@Path("/v1.0")
public class OpenAPIResourceImpl {
	...
	private final Set<Class<?>> _resourceClasses = new HashSet<Class<?>>() {
		{
			add(SecurityInfoResourceImpl.class);
...
// LIFERAY-REST-BUILDER-HASH:568127814