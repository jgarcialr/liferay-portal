...
import com.liferay.portal.security.ldap.internal.configuration.persistence.listener.LDAPCredentialCipher;
...
public class SafePortalLDAPImpl implements SafePortalLDAP {
	...
	private boolean _isLDAPS(String providerURL) {
		...
		return StringUtil.toLowerCase(providerURL).startsWith("ldaps://");
	}
