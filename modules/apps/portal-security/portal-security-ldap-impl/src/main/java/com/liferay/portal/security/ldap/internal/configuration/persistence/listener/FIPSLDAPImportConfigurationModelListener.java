			...
			throw new ConfigurationModelListenerException(
				"FIPS mode does not permit enabling user password import " +
					"from LDAP while passwords.encryption.algorithm is \"" +
						portalAlgorithm + "\"; configure a FIPS-approved " +
							"algorithm (PBKDF2*, SHA-256, SHA-384, SHA-512) " +
								"or disable the import feature",
				LDAPImportConfiguration.class, getClass(), properties);
		}
	}
