...
import com.liferay.portal.security.ldap.internal.configuration.persistence.listener.LDAPServerCredentialEncryptionModelListener;
 ...
 * {@link LDAPServerCredentialEncryptionModelListener#ENCRYPTED_VALUE_PREFIX})
		...
		for (Configuration configuration : configurations) {
			...
			if (Validator.isNull(securityCredential) ||
				securityCredential.startsWith(
					LDAPServerCredentialEncryptionModelListener.
