...
public class FIPSModeUtilTest {
	...
	public void testIsApprovedPasswordAlgorithmMixedCase() {
		Assert.assertTrue(
			FIPSModeUtil.isApprovedPasswordAlgorithm("sha-256"));
		Assert.assertTrue(
			FIPSModeUtil.isApprovedPasswordAlgorithm("pbkdf2"));
		Assert.assertTrue(
	...
	public void testIsApprovedPasswordAlgorithmRejected() {
		...
		Assert.assertFalse(FIPSModeUtil.isApprovedPasswordAlgorithm("BCRYPT/10"));
		Assert.assertFalse(
	...
	public void testIsApprovedPasswordAlgorithmShaFamily() {
		Assert.assertTrue(
			FIPSModeUtil.isApprovedPasswordAlgorithm("SHA-256"));
		Assert.assertTrue(
			FIPSModeUtil.isApprovedPasswordAlgorithm("SHA-384"));
		Assert.assertTrue(
			FIPSModeUtil.isApprovedPasswordAlgorithm("SHA-512"));
	}
